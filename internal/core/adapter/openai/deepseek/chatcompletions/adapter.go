// Package chatcompletions 实现 DeepSeek 在 OpenAI 协议族下的具体 adapter。
//
...
func NewAdapter(client *http.Client, logger *zap.Logger) *Adapter {
	...
	return &Adapter{
		base:   chatcompletionsadapter.NewAdapter(client),
		logger: logger,
	}
}
...
var (
	_ chatcompletionsadapter.ChatAdapter        = (*Adapter)(nil)
