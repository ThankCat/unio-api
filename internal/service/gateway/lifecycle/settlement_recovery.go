...
func (s *ChatSettlementRecoveryStore) CreatePendingChatSettlementRecoveryJob(ctx context.Context, params ChatSettlementParams) (sqlc.SettlementRecoveryJob, error) {
	...
	job, err := s.queries.CreateSettlementRecoveryJob(ctx, sqlc.CreateSettlementRecoveryJobParams{
		...
		UsageCacheCreation5mInputTokens:       facts.Usage.CacheCreation5mInputTokens.Value,
		UsageCacheCreation5mInputTokensState:  string(facts.Usage.CacheCreation5mInputTokens.State),
		UsageCacheCreation1hInputTokens:       facts.Usage.CacheCreation1hInputTokens.Value,
		UsageCacheCreation1hInputTokensState:  string(facts.Usage.CacheCreation1hInputTokens.State),
		UsageCacheCreation30mInputTokens:      facts.Usage.CacheCreation30mInputTokens.Value,
		UsageCacheCreation30mInputTokensState: string(facts.Usage.CacheCreation30mInputTokens.State),
		...
		CacheCreation5mInputPrice:             tierSelection.salePrice.CacheCreation5mInputPrice,
		CacheCreation1hInputPrice:             tierSelection.salePrice.CacheCreation1hInputPrice,
		CacheCreation30mInputPrice:            tierSelection.salePrice.CacheCreation30mInputPrice,
...
func (s *ChatSettlementRecoveryService) chatSettlementParamsFromJob(ctx context.Context, job sqlc.SettlementRecoveryJob) (ChatSettlementParams, error) {
	...
	return ChatSettlementParams{
		...
		SalePrice: billing.CustomerPriceSnapshot{
			...
			CacheCreation5mInputPrice:  job.CacheCreation5mInputPrice,
			CacheCreation1hInputPrice:  job.CacheCreation1hInputPrice,
			CacheCreation30mInputPrice: job.CacheCreation30mInputPrice,
...
func chatSettlementRecoveryFactsFromJob(job sqlc.SettlementRecoveryJob) adapter.ResponseFacts {
	...
	return adapter.ResponseFacts{
		...
		Usage: usage.Facts{
			...
			CacheCreation5mInputTokens:  usage.TokenCount{Value: job.UsageCacheCreation5mInputTokens, State: usage.CountState(job.UsageCacheCreation5mInputTokensState)},
			CacheCreation1hInputTokens:  usage.TokenCount{Value: job.UsageCacheCreation1hInputTokens, State: usage.CountState(job.UsageCacheCreation1hInputTokensState)},
			CacheCreation30mInputTokens: usage.TokenCount{Value: job.UsageCacheCreation30mInputTokens, State: usage.CountState(job.UsageCacheCreation30mInputTokensState)},
