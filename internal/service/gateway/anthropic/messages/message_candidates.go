...
func (s *MessagesService) prepareMessageCandidates(ctx context.Context, req dto.MessageRequest, candidates []routing.ChatRouteCandidate, stream bool, stickyChannelID int64) (lifecycle.CandidatePlan, error) {
...
func (s *MessagesService) messagesInputTokenEstimator(req dto.MessageRequest) lifecycle.CandidateInputTokenEstimator {
...
func estimateMaxOutputTokens(req dto.MessageRequest) int64 {
