...
func (s *MessagesService) prepareMessageRequestRecord(ctx context.Context, principal *auth.APIKeyPrincipal, req dto.MessageRequest, stream bool) (requestlog.CreateRequestParams, error) {
