...
func TestRouterV1ChatCompletionWithInvalidN(t *testing.T) {
	reqBody := ChatCompletionRequest{
		Model: "openai/gpt-4.1",
		Messages: []ChatMessage{
			{Role: "user", Content: jsonContent("Hello")},
	...
	assertChatCompletionInvalidRequest(t, reqBody, "n must be greater than or equal to 1", "n")
}

func TestRouterV1ChatCompletionWithTopLogprobsOutOfRange(t *testing.T) {
	reqBody := ChatCompletionRequest{
		Model: "openai/gpt-4.1",
		Messages: []ChatMessage{
			{Role: "user", Content: jsonContent("Hello")},
		...
		TopLogprobs: intPtr(21),
	}

	assertChatCompletionInvalidRequest(t, reqBody, "top_logprobs must be between 0 and 20", "top_logprobs")
}

func TestRouterV1ChatCompletionWithTopLogprobsRequiresLogprobs(t *testing.T) {
	reqBody := ChatCompletionRequest{
		Model: "openai/gpt-4.1",
		Messages: []ChatMessage{
			{Role: "user", Content: jsonContent("Hello")},
	...
	assertChatCompletionInvalidRequest(t, reqBody, "top_logprobs requires logprobs to be set to true", "top_logprobs")
}
