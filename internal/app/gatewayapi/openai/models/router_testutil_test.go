...
// ListAvailableModels 记录收到的 capability 过滤，并返回测试预设的模型列表。
func (s *routerTestModelCatalogService) ListAvailableModels(ctx context.Context, requiredCapabilities []string) ([]modelcatalog.Model, error) {
	s.called = true
