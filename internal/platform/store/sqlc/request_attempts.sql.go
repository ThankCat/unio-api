...
func (q *Queries) CreateRequestAttempt(ctx context.Context, arg CreateRequestAttemptParams) (RequestAttempt, error) {
	row := q.db.QueryRow(ctx, createRequestAttempt,
		...
		arg.StartedAt,
		arg.CompletedAt,
		arg.ProviderOriginRevision,
		arg.ProviderStatusRevision,
		arg.ChannelConfigRevision,
		arg.RoutingCandidateIndex,
		arg.UpstreamEndpoint,
		arg.RequestedServiceTier,
		arg.ForwardedServiceTier,
		arg.AccountID,
		arg.RequestRecordID,
	)
...
WITH updated AS (
    UPDATE request_attempts
        SET status = 'failed',
            ...
            upstream_service_tier = $3,
            error_code = $4,
            error_message = $5,
            internal_error_detail = $6,
            completed_at = $7
        WHERE request_attempts.id = $8
            AND request_attempts.status = 'running'
        RETURNING request_attempts.id, request_attempts.request_record_id, request_attempts.attempt_index, request_attempts.provider_id, request_attempts.channel_id, request_attempts.adapter_key, request_attempts.upstream_model, request_attempts.upstream_protocol, request_attempts.upstream_response_id, request_attempts.upstream_response_model, request_attempts.upstream_finish_reason, request_attempts.finish_class, request_attempts.status, request_attempts.upstream_status_code, request_attempts.upstream_request_id, request_attempts.error_code, request_attempts.error_message, request_attempts.internal_error_detail, request_attempts.upstream_timeout_phase, request_attempts.gateway_first_token_at, request_attempts.final_usage_received, request_attempts.usage_mapping_version, request_attempts.started_at, request_attempts.completed_at, request_attempts.created_at, request_attempts.upstream_started_at, request_attempts.upstream_first_token_at, request_attempts.upstream_completed_at, request_attempts.provider_origin_revision, request_attempts.provider_status_revision, request_attempts.channel_config_revision, request_attempts.routing_candidate_index, request_attempts.upstream_endpoint, request_attempts.breaker_provider_disposition, request_attempts.breaker_channel_disposition, request_attempts.ttft_scoring_sample, request_attempts.error_scoring_sample, request_attempts.error_scoring_failure, request_attempts.fault_party, request_attempts.permit_id, request_attempts.requested_service_tier, request_attempts.upstream_service_tier, request_attempts.forwarded_service_tier, request_attempts.account_id
)
SELECT id, request_record_id, attempt_index, provider_id, channel_id, adapter_key, upstream_model, upstream_protocol, upstream_response_id, upstream_response_model, upstream_finish_reason, finish_class, status, upstream_status_code, upstream_request_id, error_code, error_message, internal_error_detail, upstream_timeout_phase, gateway_first_token_at, final_usage_received, usage_mapping_version, started_at, completed_at, created_at, upstream_started_at, upstream_first_token_at, upstream_completed_at, provider_origin_revision, provider_status_revision, channel_config_revision, routing_candidate_index, upstream_endpoint, breaker_provider_disposition, breaker_channel_disposition, ttft_scoring_sample, error_scoring_sample, error_scoring_failure, fault_party, permit_id, requested_service_tier, upstream_service_tier, forwarded_service_tier, account_id
...
WITH updated AS (
    UPDATE request_attempts
        SET status = 'succeeded',
            ...
            upstream_service_tier = $7,
            gateway_first_token_at = COALESCE(request_attempts.gateway_first_token_at, $8),
            final_usage_received = $9,
            usage_mapping_version = $10,
            completed_at = $11
        WHERE request_attempts.id = $12
            AND request_attempts.status = 'running'
        RETURNING request_attempts.id, request_attempts.request_record_id, request_attempts.attempt_index, request_attempts.provider_id, request_attempts.channel_id, request_attempts.adapter_key, request_attempts.upstream_model, request_attempts.upstream_protocol, request_attempts.upstream_response_id, request_attempts.upstream_response_model, request_attempts.upstream_finish_reason, request_attempts.finish_class, request_attempts.status, request_attempts.upstream_status_code, request_attempts.upstream_request_id, request_attempts.error_code, request_attempts.error_message, request_attempts.internal_error_detail, request_attempts.upstream_timeout_phase, request_attempts.gateway_first_token_at, request_attempts.final_usage_received, request_attempts.usage_mapping_version, request_attempts.started_at, request_attempts.completed_at, request_attempts.created_at, request_attempts.upstream_started_at, request_attempts.upstream_first_token_at, request_attempts.upstream_completed_at, request_attempts.provider_origin_revision, request_attempts.provider_status_revision, request_attempts.channel_config_revision, request_attempts.routing_candidate_index, request_attempts.upstream_endpoint, request_attempts.breaker_provider_disposition, request_attempts.breaker_channel_disposition, request_attempts.ttft_scoring_sample, request_attempts.error_scoring_sample, request_attempts.error_scoring_failure, request_attempts.fault_party, request_attempts.permit_id, request_attempts.requested_service_tier, request_attempts.upstream_service_tier, request_attempts.forwarded_service_tier, request_attempts.account_id
)
SELECT id, request_record_id, attempt_index, provider_id, channel_id, adapter_key, upstream_model, upstream_protocol, upstream_response_id, upstream_response_model, upstream_finish_reason, finish_class, status, upstream_status_code, upstream_request_id, error_code, error_message, internal_error_detail, upstream_timeout_phase, gateway_first_token_at, final_usage_received, usage_mapping_version, started_at, completed_at, created_at, upstream_started_at, upstream_first_token_at, upstream_completed_at, provider_origin_revision, provider_status_revision, channel_config_revision, routing_candidate_index, upstream_endpoint, breaker_provider_disposition, breaker_channel_disposition, ttft_scoring_sample, error_scoring_sample, error_scoring_failure, fault_party, permit_id, requested_service_tier, upstream_service_tier, forwarded_service_tier, account_id
...
WITH updated AS (
    UPDATE request_attempts
        SET status = 'canceled',
            ...
            error_code = $8,
            error_message = $9,
            internal_error_detail = $10,
            gateway_first_token_at = COALESCE(request_attempts.gateway_first_token_at, $11),
            final_usage_received = $12,
            usage_mapping_version = $13,
            completed_at = $14
        WHERE request_attempts.id = $15
            AND request_attempts.status = 'running'
        RETURNING request_attempts.id, request_attempts.request_record_id, request_attempts.attempt_index, request_attempts.provider_id, request_attempts.channel_id, request_attempts.adapter_key, request_attempts.upstream_model, request_attempts.upstream_protocol, request_attempts.upstream_response_id, request_attempts.upstream_response_model, request_attempts.upstream_finish_reason, request_attempts.finish_class, request_attempts.status, request_attempts.upstream_status_code, request_attempts.upstream_request_id, request_attempts.error_code, request_attempts.error_message, request_attempts.internal_error_detail, request_attempts.upstream_timeout_phase, request_attempts.gateway_first_token_at, request_attempts.final_usage_received, request_attempts.usage_mapping_version, request_attempts.started_at, request_attempts.completed_at, request_attempts.created_at, request_attempts.upstream_started_at, request_attempts.upstream_first_token_at, request_attempts.upstream_completed_at, request_attempts.provider_origin_revision, request_attempts.provider_status_revision, request_attempts.channel_config_revision, request_attempts.routing_candidate_index, request_attempts.upstream_endpoint, request_attempts.breaker_provider_disposition, request_attempts.breaker_channel_disposition, request_attempts.ttft_scoring_sample, request_attempts.error_scoring_sample, request_attempts.error_scoring_failure, request_attempts.fault_party, request_attempts.permit_id, request_attempts.requested_service_tier, request_attempts.upstream_service_tier, request_attempts.forwarded_service_tier, request_attempts.account_id
)
SELECT id, request_record_id, attempt_index, provider_id, channel_id, adapter_key, upstream_model, upstream_protocol, upstream_response_id, upstream_response_model, upstream_finish_reason, finish_class, status, upstream_status_code, upstream_request_id, error_code, error_message, internal_error_detail, upstream_timeout_phase, gateway_first_token_at, final_usage_received, usage_mapping_version, started_at, completed_at, created_at, upstream_started_at, upstream_first_token_at, upstream_completed_at, provider_origin_revision, provider_status_revision, channel_config_revision, routing_candidate_index, upstream_endpoint, breaker_provider_disposition, breaker_channel_disposition, ttft_scoring_sample, error_scoring_sample, error_scoring_failure, fault_party, permit_id, requested_service_tier, upstream_service_tier, forwarded_service_tier, account_id
...
const recordRequestAttemptBreakerDisposition = `-- name: RecordRequestAttemptBreakerDisposition :one
UPDATE request_attempts
...
func (q *Queries) RecordRequestAttemptBreakerDisposition(ctx context.Context, arg RecordRequestAttemptBreakerDispositionParams) (RequestAttempt, error) {
	row := q.db.QueryRow(ctx, recordRequestAttemptBreakerDisposition, arg.BreakerProviderDisposition, arg.BreakerChannelDisposition, arg.AttemptID)
	var i RequestAttempt
	err := row.Scan(
		&i.ID,
		&i.RequestRecordID,
