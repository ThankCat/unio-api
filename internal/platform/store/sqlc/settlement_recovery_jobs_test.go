...
func settlementRecoveryJobParams(f settlementRecoveryFixture, nextRunAt time.Time) sqlc.CreateSettlementRecoveryJobParams {
	return sqlc.CreateSettlementRecoveryJobParams{
		...
		UsageCacheCreation5mInputTokens:       0,
		UsageCacheCreation5mInputTokensState:  "not_applicable",
		UsageCacheCreation1hInputTokens:       0,
		UsageCacheCreation1hInputTokensState:  "not_applicable",
		UsageCacheCreation30mInputTokens:      0,
		UsageCacheCreation30mInputTokensState: "not_applicable",
		...
		CacheCreation5mInputPrice:   f.channelPrice.CacheCreation5mInputCost,
		CacheCreation1hInputPrice:   f.channelPrice.CacheCreation1hInputCost,
		CacheCreation30mInputPrice:  f.channelPrice.CacheCreation30mInputCost,
