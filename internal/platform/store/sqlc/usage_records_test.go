...
func usageRecordParams(requestRecordID int64) sqlc.CreateUsageRecordParams {
	return sqlc.CreateUsageRecordParams{
		...
		CacheCreation5mInputTokensState:  "not_applicable",
		CacheCreation1hInputTokens:       0,
		CacheCreation1hInputTokensState:  "not_applicable",
		CacheCreation30mInputTokens:      0,
		CacheCreation30mInputTokensState: "not_applicable",
...
func TestUsageRecordRejectsInvalidFacts(t *testing.T) {
	cases := []struct {
		...
		},
		{
			...
			mutate: func(params *sqlc.CreateUsageRecordParams) {
				params.CacheCreation5mInputTokensState = "unknown"
				params.CacheCreation5mInputTokens = 1
			},
		},
		{
