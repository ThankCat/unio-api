...
SELECT
    ...
    sqlc.narg(sale_cache_write_1h_input_price),
    sqlc.narg(sale_cache_write_30m_input_price),
...
SELECT
    ...
    sqlc.narg(fast_sale_cache_write_5m_input_price),
    sqlc.narg(fast_sale_cache_write_1h_input_price),
    sqlc.narg(fast_sale_cache_write_30m_input_price),
