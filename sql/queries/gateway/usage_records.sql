...
VALUES (
    ...
    sqlc.arg(cache_creation_5m_input_tokens),
    sqlc.arg(cache_creation_5m_input_tokens_state),
    sqlc.arg(cache_creation_1h_input_tokens),
    sqlc.arg(cache_creation_1h_input_tokens_state),
    sqlc.arg(cache_creation_30m_input_tokens),
    sqlc.arg(cache_creation_30m_input_tokens_state),
